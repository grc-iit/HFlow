...
namespace rhea{
    class RheaClient {
    private:
        basket::unordered_map<Parcel,DataHolder> warehouse;
    ...
    public:
        RheaClient():warehouse("DATA_WAREHOUSE"),write_queue("WRITE_QUEUE"),read_queue("READ_QUEUE"),parsel_state("PARSEL_STATE"){}
