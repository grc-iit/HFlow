...
class TestCollectorsArgs : public common::args::ArgMap {
private:
...
public:
    void Usage(void) {
        ...
        std::cout << "-cs [int]: Number of collectors."
    ...
    TestCollectorsArgs(int argc, char **argv) {
        ...
        AddOpt("-cs", common::args::ArgType::kInt, 1);
